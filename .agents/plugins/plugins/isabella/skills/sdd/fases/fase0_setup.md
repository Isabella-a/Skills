# Fase 0 — Perfil da entrega (roda uma vez por repositório)
...
## 0.0 — `PROJECT_MAP.md` existe?

```bash
cat PROJECT_MAP.md 2>/dev/null | head -20
```

- **Existe:** leia o arquivo inteiro e guarde o conteúdo para as fases seguintes. Siga para 0.1.
...
- **Existe mas está desatualizado** (usuário pediu `--setup`, ou a unidade de entrega mudou):
  refaça 0.2 e sobrescreva, avisando o que mudou.
- **Não existe:** siga para 0.2.

## 0.2 — Descubra a unidade de entrega
