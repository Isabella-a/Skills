...
5. **Lista de specs — apresente, não pergunte em aberto:** derive você mesmo a divisão em
   ...
   precisa de spec própria), e os helpers/componentes reutilizáveis da Fase 4 (reduz o
...
Não repita perguntas já respondidas na Fase 2. Só pergunte o que ainda é genuinamente incerto.

A lista de specs apresentada e confirmada aqui define diretamente os arquivos `specs/NN-nome.md`
que serão criados na Fase 6.
